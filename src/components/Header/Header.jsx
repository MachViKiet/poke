  ...
  return (
    <header className={styles.header}>
      <div className={styles.themeToggle}>
        <label htmlFor="themeSwitch" className={styles.toggle} aria-label="Switch-Theme">
          <input type="checkbox"
            id="themeSwitch"
            checked={on}
          ...
          <span className={styles.thumb}>
            <img src={on ? "/moon.png" : "/sun.png" } alt="" width="18" height="18" />
          </span>
        </label>
      </div>


      <div className={styles.logoContainer}><img className={styles.logo} src="/logo.png" alt="Pokedex Logo" /></div>

      <div className={styles.githubIcon}><a href="https://github.com/thiagosampaiog/pokedex" target="_blank" rel="noreferrer" aria-label="GitHub">
